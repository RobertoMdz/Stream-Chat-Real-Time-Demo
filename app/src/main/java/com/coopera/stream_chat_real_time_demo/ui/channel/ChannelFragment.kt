package com.coopera.stream_chat_real_time_demo.ui.channel
...
import com.coopera.stream_chat_real_time_demo.databinding.FragmentChannelBinding
...
class ChannelFragment : Fragment() {
    ...
    private fun setupUser() {
        if (client.getCurrentUser() == null) {
            user = if (args.chatUser.firstName.contains("Roberto")) {
                User(
                    id = args.chatUser.userName,
                    extraData = mutableMapOf(
                        "name" to args.chatUser.firstName,
                        "country" to "México",
                        "image" to "https://i.postimg.cc/V6L7rWqC/Dash.png"
                    )
                )
            } else {
                User(
            ...
            client.connectUser(
                ...
                if (result.isSuccess) {
                    Log.d("ChannelFragment", "Usuario conectado exitosamente")
                } else {
